...
const CreditsEditor = ({ editorText, handleConfirm, handleSliderOpening, credits, handleSetCredits }) => {
  return (
    <div className="cp-editor-container">
      ...
      {/* Back button */}
      <Button text="Back" btnColor="rgb(0, 62, 76)" onClick={() => handleSliderOpening({ add: false, edit: false })} />
    </div>
  );
};
